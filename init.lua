...
-- <C-l> is reserved for AI/Claude (Cursor-style); right-window focus moved to <leader>l
...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      -- local capabilities = require('blink.cmp').get_lsp_capabilities() this was the old
  ...
  { -- Highlight, edit, and navigate code
    ...
    -- The `main` branch is a rewrite: no `nvim-treesitter.configs`, no
    -- `ensure_installed`/`highlight` opts. Parsers are installed with
    -- `install()` and highlighting/indent are enabled per buffer below.
    branch = 'main',
    build = ':TSUpdate',
    lazy = false,
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'cpp', 'c_sharp' }
  ...
  -- No plugins require luarocks; disable to avoid broken hererocks warnings
  rocks = { enabled = false },
  ui = {
